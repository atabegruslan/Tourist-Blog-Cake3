...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => 'normal', 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'sid' => ['type' => 'string', 'length' => 500, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'email_verified_at' => 1604648609,
                'password' => 'Lorem ipsum dolor sit amet',
                'remember_token' => 'Lorem ipsum dolor sit amet',
                'created_at' => 1604648609,
                'updated_at' => 1604648609,
                'type' => 'Lorem ip',
