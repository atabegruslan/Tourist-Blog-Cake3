 ...
 * Users Model
 *
 * @property \AdminPanel\Model\Table\EntriesTable&\Cake\ORM\Association\HasMany $Entries
 *
 ...
 * @method \AdminPanel\Model\Entity\User|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \AdminPanel\Model\Entity\User saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
